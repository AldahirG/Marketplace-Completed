...
public class CategoryService {
    ...
    public ResponseEntity<Message> findById(long id){
        if (categoryRepository.existsById(id)){
            return new ResponseEntity<>(new Message("OK",false,categoryRepository.getById(id)),
                    HttpStatus.OK);
        }
    ...
    public ResponseEntity<Message> save(Category category) {
        ...
        return new ResponseEntity<>(new Message("Categoría Registrada",false,saveCategory),HttpStatus.OK);
    }
